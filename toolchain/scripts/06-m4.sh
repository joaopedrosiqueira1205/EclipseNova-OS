...
# M4 1.4.21 - Ferramenta Temporaria
# ==========================================
...
SOURCE="$LFS/sources/m4-1.4.21"

if [ ! -d "$SOURCE" ]; then
    echo "[ERRO] Fontes do M4 1.4.21 nao encontradas:"
    echo "$SOURCE"
    exit 1
fi
...
echo
echo "[2/3] Compilando M4..."

make -j"$BUILD_JOBS"

echo
echo "[3/3] Instalando M4..."

make DESTDIR="$LFS" install

echo
echo "======================================"
echo " [OK] M4 1.4.21 concluido"
echo "======================================"